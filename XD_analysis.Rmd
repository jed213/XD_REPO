...
# Residuals vs fitted values
plot(residuals(model10.5, type="response") ~ model10.5$fitted.values)
abline(0,0,col="gray")

# Residuals vs Age
plot(residuals(model10.5, type="response") ~ model10.5$model$age.days.S)
abline(0,0,col="gray")

# Residuals vs Stage
plot(residuals(model10.5, type="response") ~ model10.5$model$stage.S)
abline(0,0,col="gray")
```
